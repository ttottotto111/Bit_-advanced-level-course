...
{
	GetDlgItemText(hDlg, IDC_EDIT3, pmemberdata->id, sizeof(pmemberdata->id));
	GetDlgItemText(hDlg, IDC_EDIT4, pmemberdata->pw, sizeof(pmemberdata->pw));
	GetDlgItemText(hDlg, IDC_EDIT5, pmemberdata->name, sizeof(pmemberdata->name));
