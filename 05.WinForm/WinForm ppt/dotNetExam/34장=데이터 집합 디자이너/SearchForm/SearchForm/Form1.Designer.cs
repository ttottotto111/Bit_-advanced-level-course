namespace SearchForm
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			this.fillByAgeToolStrip = new System.Windows.Forms.ToolStrip();
			...
			this.fillByAgeToolStripButton = new System.Windows.Forms.ToolStripButton();
			...
			this.aDOTestDataSet = new SearchForm.ADOTestDataSet();
			this.tblPeopleTableAdapter = new SearchForm.ADOTestDataSetTableAdapters.tblPeopleTableAdapter();
			this.tableAdapterManager = new SearchForm.ADOTestDataSetTableAdapters.TableAdapterManager();
			...
			this.fillByAgeToolStrip.SuspendLayout();
			...
			this.tblPeopleBindingNavigator.Size = new System.Drawing.Size(450, 25);
			...
			this.tblPeopleDataGridView.Location = new System.Drawing.Point(12, 78);
			this.tblPeopleDataGridView.Name = "tblPeopleDataGridView";
			this.tblPeopleDataGridView.RowTemplate.Height = 23;
			this.tblPeopleDataGridView.Size = new System.Drawing.Size(418, 178);
			this.tblPeopleDataGridView.TabIndex = 1;
			// 
			// fillByAgeToolStrip
			// 
			this.fillByAgeToolStrip.Items.AddRange(new System.Windows.Forms.ToolStripItem[] {
            this.ageToolStripLabel,
            this.ageToolStripTextBox,
            this.fillByAgeToolStripButton});
			this.fillByAgeToolStrip.Location = new System.Drawing.Point(0, 25);
			this.fillByAgeToolStrip.Name = "fillByAgeToolStrip";
			this.fillByAgeToolStrip.Size = new System.Drawing.Size(450, 25);
			this.fillByAgeToolStrip.TabIndex = 2;
			this.fillByAgeToolStrip.Text = "fillByAgeToolStrip";
			// 
			// ageToolStripLabel
			// 
			this.ageToolStripLabel.Name = "ageToolStripLabel";
			this.ageToolStripLabel.Size = new System.Drawing.Size(31, 22);
			this.ageToolStripLabel.Text = "Age:";
			// 
			// ageToolStripTextBox
			// 
			this.ageToolStripTextBox.Name = "ageToolStripTextBox";
			this.ageToolStripTextBox.Size = new System.Drawing.Size(100, 25);
			// 
			// fillByAgeToolStripButton
			// 
			this.fillByAgeToolStripButton.DisplayStyle = System.Windows.Forms.ToolStripItemDisplayStyle.Text;
			this.fillByAgeToolStripButton.Name = "fillByAgeToolStripButton";
			this.fillByAgeToolStripButton.Size = new System.Drawing.Size(119, 22);
			this.fillByAgeToolStripButton.Text = "보다 늙은 사람 찾기";
			this.fillByAgeToolStripButton.Click += new System.EventHandler(this.fillByAgeToolStripButton_Click);
			// 
			// fillByNameToolStrip
			// 
			...
			this.fillByNameToolStrip.Location = new System.Drawing.Point(0, 50);
			this.fillByNameToolStrip.Name = "fillByNameToolStrip";
			this.fillByNameToolStrip.Size = new System.Drawing.Size(450, 25);
			...
			this.fillByNameToolStripButton.Size = new System.Drawing.Size(71, 22);
			...
			this.tableAdapterManager.UpdateOrder = SearchForm.ADOTestDataSetTableAdapters.TableAdapterManager.UpdateOrderOption.InsertUpdateDelete;
			// 
			// Form1
			// 
			...
			this.Controls.Add(this.fillByAgeToolStrip);
			...
			this.fillByAgeToolStrip.ResumeLayout(false);
			this.fillByAgeToolStrip.PerformLayout();
		...
		private SearchForm.ADOTestDataSetTableAdapters.tblPeopleTableAdapter tblPeopleTableAdapter;
		private SearchForm.ADOTestDataSetTableAdapters.TableAdapterManager tableAdapterManager;
		...
		private System.Windows.Forms.ToolStrip fillByAgeToolStrip;
		...
		private System.Windows.Forms.ToolStripButton fillByAgeToolStripButton;
