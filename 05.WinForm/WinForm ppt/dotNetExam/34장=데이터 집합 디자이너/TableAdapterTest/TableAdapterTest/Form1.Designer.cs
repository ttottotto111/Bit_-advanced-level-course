namespace TableAdapterTest
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			this.aDOTestDataSet = new TableAdapterTest.ADOTestDataSet();
			this.tblPeopleTableAdapter = new TableAdapterTest.ADOTestDataSetTableAdapters.tblPeopleTableAdapter();
			this.tableAdapterManager = new TableAdapterTest.ADOTestDataSetTableAdapters.TableAdapterManager();
			this.tblSaleBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.tblSaleTableAdapter = new TableAdapterTest.ADOTestDataSetTableAdapters.tblSaleTableAdapter();
			...
			this.tblPeopleBindingNavigator.Size = new System.Drawing.Size(476, 25);
			...
			this.tblPeopleDataGridView.Size = new System.Drawing.Size(452, 142);
			...
			this.tableAdapterManager.UpdateOrder = TableAdapterTest.ADOTestDataSetTableAdapters.TableAdapterManager.UpdateOrderOption.InsertUpdateDelete;
			// 
			...
			this.tblSaleDataGridView.Location = new System.Drawing.Point(12, 176);
			this.tblSaleDataGridView.Name = "tblSaleDataGridView";
			this.tblSaleDataGridView.RowTemplate.Height = 23;
			this.tblSaleDataGridView.Size = new System.Drawing.Size(452, 150);
		...
		private TableAdapterTest.ADOTestDataSetTableAdapters.tblPeopleTableAdapter tblPeopleTableAdapter;
		private TableAdapterTest.ADOTestDataSetTableAdapters.TableAdapterManager tableAdapterManager;
		...
		private TableAdapterTest.ADOTestDataSetTableAdapters.tblSaleTableAdapter tblSaleTableAdapter;
