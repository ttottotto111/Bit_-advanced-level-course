namespace Validation2
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			this.aDOTestDataSet = new Validation2.ADOTestDataSet();
			this.tblPeopleBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.tblPeopleTableAdapter = new Validation2.ADOTestDataSetTableAdapters.tblPeopleTableAdapter();
			this.tableAdapterManager = new Validation2.ADOTestDataSetTableAdapters.TableAdapterManager();
			...
			this.tableAdapterManager.UpdateOrder = Validation2.ADOTestDataSetTableAdapters.TableAdapterManager.UpdateOrderOption.InsertUpdateDelete;
			// 
			...
			this.tblPeopleBindingNavigator.Size = new System.Drawing.Size(406, 25);
			...
			this.tblPeopleDataGridView.Size = new System.Drawing.Size(377, 201);
		...
		private Validation2.ADOTestDataSetTableAdapters.tblPeopleTableAdapter tblPeopleTableAdapter;
		private Validation2.ADOTestDataSetTableAdapters.TableAdapterManager tableAdapterManager;
