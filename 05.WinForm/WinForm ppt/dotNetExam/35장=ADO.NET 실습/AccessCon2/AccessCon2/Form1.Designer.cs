namespace AccessCon2
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			this.aDOTestDataSet = new AccessCon2.ADOTestDataSet();
			this.tblPeopleBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.tblPeopleTableAdapter = new AccessCon2.ADOTestDataSetTableAdapters.tblPeopleTableAdapter();
			this.tableAdapterManager = new AccessCon2.ADOTestDataSetTableAdapters.TableAdapterManager();
			...
			this.tableAdapterManager.UpdateOrder = AccessCon2.ADOTestDataSetTableAdapters.TableAdapterManager.UpdateOrderOption.InsertUpdateDelete;
			// 
			...
			this.tblPeopleBindingNavigator.Size = new System.Drawing.Size(394, 25);
			...
			this.tblPeopleDataGridView.Size = new System.Drawing.Size(372, 156);
		...
		private AccessCon2.ADOTestDataSetTableAdapters.tblPeopleTableAdapter tblPeopleTableAdapter;
		private AccessCon2.ADOTestDataSetTableAdapters.TableAdapterManager tableAdapterManager;
