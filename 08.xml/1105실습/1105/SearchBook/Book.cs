...
namespace _1105
{
    class Book
    {
        ...
        public Book(string title, string author, int price, string publisher, string description, string image, string link)
        {
            Title = title;
            Author = author;
            Price = price;
        ...
        static internal Book MakeBook(XmlNode xn)
        {
            ...
            return new Book(title, author, price, publisher, description, image, link);
        }
