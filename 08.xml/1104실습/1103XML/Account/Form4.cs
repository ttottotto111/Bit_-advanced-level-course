...
namespace _1103XML
{
    public partial class Form4 : Form
    {
        ...
        {
            AccountDom.GetXMLFileLoad("accounts.xml");
            textBox1.Text = AccountDom.GetXmlData();

            List<Wb.XMLPaser.Account> acclist = AccountDom.DocumentPrint();
        ...
        {
            AccountioDom.GetXMLFileLoad("acclistio.xml");
            textBox2.Text = AccountioDom.GetXmlData();

            List<Wb.XMLPaser.AccountIO> acclist = AccountioDom.DocumentPrint();
